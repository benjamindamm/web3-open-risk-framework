#!/usr/bin/env node
import { printErrorSummary, printSuccessMessage, validateAllReferences } from './utils/index.js';
...
function main() {
    ...
    const result = validateAllReferences(catalogueDir, moduleRoot, 'Validating References in Module Risk Framework');
