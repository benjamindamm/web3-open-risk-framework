import { extractAndParseYaml, findFiles, getRelativePath, printFileResults, printSuccessMessage, printValidationHeader, printValidationSummary, readFileSafely, validateAgainstSchema } from './utils/index.js';
import fs from 'fs';
...
async function main() {
    printValidationHeader('Validating Markdown files with YAML metadata...', 'Expected format: ```yaml ... ``` blocks (preferred) or --- frontmatter (legacy)');
